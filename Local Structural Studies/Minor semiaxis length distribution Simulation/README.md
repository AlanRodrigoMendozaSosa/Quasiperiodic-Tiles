The files contained in this folder correspond to the functions used to compute the minor semiaxis length distribution in quasiperiodic lattices of rotational symmetry N = 1009.
