...
function parche_Cuadrado(Informacion_Parche, Semilado, Factor_Reduccion, Punto = true)
    ...
    Coordenadas_X1, Coordenadas_Y1, P_1 = region_Local_Voronoi(Informacion_Parche[1], Informacion_Parche[2], P_1);
    Coordenadas_X2, Coordenadas_Y2, P_2 = region_Local_Voronoi(Informacion_Parche[1], Informacion_Parche[2], P_2);
    Coordenadas_X3, Coordenadas_Y3, P_3 = region_Local_Voronoi(Informacion_Parche[1], Informacion_Parche[2], P_3);
    Coordenadas_X4, Coordenadas_Y4, P_4 = region_Local_Voronoi(Informacion_Parche[1], Informacion_Parche[2], P_4);
    ...
    println("Hay un total de ",length(Arreglo_Centroides), " polígonos con posibles duplicados.")
    unique!(Arreglo_Centroides);    
    println("Hay un total de ", length(Arreglo_Centroides), " polígonos únicos.")
    ...
    return Coordenadas_X_CPC, Coordenadas_Y_CPC
