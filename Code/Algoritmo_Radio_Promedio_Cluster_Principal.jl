...
function radio_Seguro(Margen_Error, Semilado, Cota_Area, Iteraciones_Algoritmo, Promedios_Distancia, Vectores_Estrella, Arreglo_Alfas)
    ...
    for i in 1:Iteraciones_Algoritmo
        ...
        #Obtención del teselado de Voronoi a partir de los Centroides
        ...
        Centroides_Principal = centroides_Area_Acotada(Initial_Voronoi, Cota_Area, Punto_Arbitrario);
        
        #Visualizamos ahora el arreglo cuasiperiódico tras quitarle las n capas.
        Coordenadas_X, Coordenadas_Y = centroides_A_Vertices(Centroides_Principal, Diccionario_Centroides);
