...
function arreglo_Numero_Lados_Buenos_Poligonos(Iteraciones, Iteraciones_Cluster, Area_Cota, Margen_Error, Semilado_Caja, Promedios_Distancia, Vectores_Estrella, Arreglo_Alfas)
    ...
    for i in 1:Iteraciones
        ...
        for i in Centroides_Iterados #Checamos únicamente los polígonos del cluster principal
            Face = voronoi_Inicial.faces[Diccionario_Centroides_Indice[i]]; #Polígono del clúster principal que estamos evaluando
